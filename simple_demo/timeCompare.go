...
func main() {
	...
	// 比较
	format := "2006-01-02T15:04:05.822+08:00"
	now := time.Now()
	//now, _ := time.Parse(format, time.Now().Format(format))
	a, _ := time.Parse(format, "2020-12-18T15:38:48.822+08:00")
	b, _ := time.Parse(format, "2020-10-18T15:38:48.822+08:00")
	fmt.Println("now  a   After: ", now.After(a))
	fmt.Println("now  b   After:", now.After(b))
	fmt.Println("a  b   After:", b.After(a))
	fmt.Println(b)
